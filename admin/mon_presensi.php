...
if(isset($_GET['hapus'])){
    ...
    echo "<script>alert('Sesi Presensi dihapus'); window.location='mon_presensi.php';</script>";
}
?>
<!DOCTYPE html>
<html lang="id">
<head>
    <title>Monitoring Presensi - ALC Admin</title>
    ...
    <style>
        ...
        .badge { padding: 4px 8px; border-radius: 4px; background: #d1fae5; color: #065f46; font-size: 0.75rem; font-weight: 600; }
    </style>
</head>
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="mon_presensi.php" class="active"><i class="fas fa-clock"></i> Rekap Presensi</a></li>
        </ul>
    ...
    <div class="main-content">
        <h2 style="margin-top:0; color:#0f172a;">Monitoring Sesi Presensi</h2>
        <div class="card">
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php 
                    $query = "SELECT presensi.*, mapel.nama_mapel, kelas.nama_kelas 
                              FROM presensi 
                              JOIN mapel ON presensi.mapel_id = mapel.id 
                    ...
                    <tr>
                        ...
                        <td><?php echo ($d['status_aktif']=='Y') ? 'Aktif' : 'Tutup'; ?></td>
                        <td>
                            <a href="mon_presensi.php?hapus=<?php echo $d['id']; ?>" class="btn-delete" onclick="return confirm('Hapus sesi presensi ini?')">Hapus</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
